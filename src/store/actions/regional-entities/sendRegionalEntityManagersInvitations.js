...
const sendRegionalEntityManagersInvitations = (item, managers, prevManagers) => {
    const filterUpdatedOnly = (managersItems, prevManagersItems) => {
        if (managersItems.length && prevManagers && prevManagersItems.length) {
...
export default sendRegionalEntityManagersInvitations;
