...
import { addCoursesBatch } from '../../../../../store/actions/courses';
...
const CoursesBatchUploader = () => {
    ...
    const handleOnSubmitBatch = csv => {
        if (csv && csv.data && csv.data.length) {
            ...
            // dispatch(addCoursesBatch(csv.data))
            //     .then(batchResults => {
    ...
    return (
        <ImportRecordsInput
            ...
            samplefileName="cursos-ejemplo-importable"
            batchLoader={
...
CoursesBatchUploader.propTypes = {};

CoursesBatchUploader.defaultProps = {};

export default CoursesBatchUploader;
