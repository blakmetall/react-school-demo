...
const LearningCommunityManagersSelectable = ({ managers, onChange, className }) => {
...
LearningCommunityManagersSelectable.propTypes = {
    managers: PropTypes.array,
    onChange: PropTypes.func,
    className: PropTypes.string,
};

LearningCommunityManagersSelectable.defaultProps = {
    managers: [],
    onChange: () => {},
    className: undefined,
};

export default LearningCommunityManagersSelectable;
