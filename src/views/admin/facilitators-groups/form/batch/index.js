...
const FacilitatorsGroupsBatchUploader = () => {
...
FacilitatorsGroupsBatchUploader.propTypes = {};

FacilitatorsGroupsBatchUploader.defaultProps = {};

export default FacilitatorsGroupsBatchUploader;
