...
import { addRegionalEntitiesBatch } from '../../../../../store/actions/regional-entities';
...
const RegionalEntitiesBatchUploader = () => {
    ...
    const handleOnSubmitBatch = csv => {
        if (csv && csv.data && csv.data.length) {
            ...
            // dispatch(addRegionalEntitiesBatch(csv.data))
            //     .then(batchResults => {
    ...
    return (
        <ImportRecordsInput
            ...
            samplefileName="entidades-regionales-ejemplo-importable"
            batchLoader={
...
RegionalEntitiesBatchUploader.propTypes = {};

RegionalEntitiesBatchUploader.defaultProps = {};

export default RegionalEntitiesBatchUploader;
