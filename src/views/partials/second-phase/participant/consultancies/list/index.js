...
const ConsultanciesListFacilitator = () => {
        ...
        return (
            <div className="d-flex align-items-center justify-content-between flex-column flex-lg-row w-100">
                ...
                <div className="app-font-19 font-weight-500 text-center mb-3 mb-lg-0">
                    Asesoría de la tarea:
                    <span> investigación lorem large text</span>
                </div>
    ...
    return (
        <>
            {/* todo refactor para recibir un avatar en la posición del titulo */}
            {/* problema con el dropdown, d-flex justify-between...  entre el titulo y el children. */}
            <Dropdown isOpenByDefault={false} className="mb-3 flex-column" headerReplacer={() => dropdownHeader()}>
