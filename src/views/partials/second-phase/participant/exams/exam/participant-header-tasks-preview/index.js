            ...
            <Row>
                ...
                <Col className="col-12 ">
                    <Row className="justify-content-between align-items-center mx-0 mb-3">
                        <div className="app-font-18 text-gray-500 font-weight-500 mb-3">Exámen “Investigación de Fé”</div>
                    ...
                    <Col className="col-12 p-0">
                        ...
                        <div className="d-flex flex-column flex-lg-row mb-4">
                            ...
                            <a
                                href="https://www.questionpro.com/es/examenes-online.html"
                                className="text-app-blue-3 font-weight-600 "
                            >
                                https://www.questionpro.com/es/examenes-online.html
                            </a>
                        </div>
                    </Col>
                </Col>
...
export default ParticipantExamView;
