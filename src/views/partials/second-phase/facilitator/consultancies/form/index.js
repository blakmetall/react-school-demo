...
import AvatarsWhitCheckBoxes from './AvatarWhitCheckBoxes';
            ...
            <Row>
                ...
                <Col className="col-12 col-lg-6">
                    ...
                    <StyledAvatarsWrapper className="mb-3 mb-lg-0 p-3 rounded-15">
                        <AvatarsWhitCheckBoxes className="mb-3 mr-1 p-0" id="1" checked />
                        <AvatarsWhitCheckBoxes className="mb-3 mr-1 p-0" id="2" />
                        <AvatarsWhitCheckBoxes className="mb-3 mr-1  p-0" id="3" />
                        <AvatarsWhitCheckBoxes className="mb-3 mr-1  p-0" id="4" checked />
                        <AvatarsWhitCheckBoxes className="mb-3 mr-1  p-0" id="5" />
                        <AvatarsWhitCheckBoxes className="mb-3 mr-1  p-0" id="6" checked />
                        <AvatarsWhitCheckBoxes className="mb-3 p-0" id="7" />
                        <AvatarsWhitCheckBoxes className="mb-3 p-0" id="8" />
