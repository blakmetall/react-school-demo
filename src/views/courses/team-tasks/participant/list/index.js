...
const ParticipantTeamTasksList = () => {
    ...
    return (
        <>
                ...
                <div>
                    <div className="d-flex flex-column flex-lg-row">
                        <Col className="col-12 col-lg-9 p-0 mb-4">
                            ...
                            <Link
                                to={`/curso/${courseId}/tareas-en-equipo/:teamTaskId`}
            ...
            <Dropdown
                ...
                headerChildren={() => (
                    <div className="d-flex align-items-center flex-nowrap">
                        <h2 className="app-font-16 app-font-19 font-weight-500 title">Finalizada</h2>
                    </div>
                )}
            >
                <div>
                    <div className="d-flex flex-column flex-lg-row">
                        <Col className="col-12 col-lg-9 p-0 mb-4">
                            ...
                            <Link
                                to="/curso/:courseId/participant/teamtasks/task-finalized" //todo: controlar los estados de las tareas
                                className="app-font-14  font-weight-600 ml-auto text-app-blue-2"
                            >
                                Ver tarea...
                            </Link>
...
export default ParticipantTeamTasksList;
