...
import AvatarTable from '../../../../partials/svg/group-table.svg'
const FacilitatorTeamTasksForm = () => {
    ...
    return (
        <Form>
            <Row>
                ...
                <Col className="col-12 col-lg-6">
                    {/* <AvatarsTeamGroups /> */}
                    <a href="#/" onClick={() => history.push(`/curso/${courseId}/tarea/:taskId/retroalimentacion`)}>
...
export default FacilitatorTeamTasksForm;
