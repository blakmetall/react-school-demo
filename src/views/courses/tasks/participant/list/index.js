        ...
        <>
            ...
            >
                <Col>
                    ...
                    <Link to={`/curso/${courseId}/tarea/:taskId`} className="app-font-14 font-weight-600 ml-auto">
                        Ver tarea...
                    </Link>
                </Col>
            </Dropdown>
            ...
            >
                <Col>
                    ...
                    <StyledFooter>
                        {/* todo: controlar las tareas finalizadas */}
                        <Link
                            to={`/curso/:courseId/participant/participant-task-finalized`} //fake
